...
RUN cd /usr/src/roundcubemail \
  ...
  && composer --prefer-dist --no-interaction --optimize-autoloader --apcu-autoloader require roundcube/carddav  johndoh/contextmenu jfcherng/show-folder-size kolab/calendar \
