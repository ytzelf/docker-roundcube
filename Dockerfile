...
RUN cd /usr/src/roundcubemail \
  ...
  && composer --prefer-dist --no-interaction --optimize-autoloader --apcu-autoloader require roundcube/carddav:dev-master johndoh/contextmenu:dev-master jfcherng/show-folder-size:dev-master mfreiholz/persistent_login:dev-master \
